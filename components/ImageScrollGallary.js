...
export default function ImageScrollGallery() {
  return (
    <main className="relative h-[400px] w-full p-4 clip-trapezoid">
      {/* Overlay fade */}
      <div className="pointer-events-none absolute top-0 left-0 w-full h-full z-10 bg-gradient-to-b from-black to-black/10" />

      {/* Scroll container with scroll disabled */}
      <div className="relative h-[400px] w-full rounded-xl p-4 disable-scroll">
        {/* Auto-scrolling grid */}
        <div className="auto-scroll-y">
          <div
